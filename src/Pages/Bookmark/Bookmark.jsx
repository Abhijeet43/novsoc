...
import { getPosts, getAllBookmarks } from "../../redux/asyncThunk/";
...
const Bookmark = () => {
  ...
  return (
    <>
      {bookmarkStatus === "pending" ? <Loader /> : null}
      {status === "resolved" ? (
        <>
          <Header setShowPostModal={setShowPostModal} />
          <main className="main-section">
            <section className="main-container bookmark-container">
              <section className="card-container bookmark-card-container">
